...
SAMPLER_TYPES = {SamplerType.DYNEX: "Dynex n.quantum", SamplerType.KMEANS: "Classical Computation"}
                            ...
                            dcc.Tabs(
                                ...
                                children=[
                                    ...
                                    dcc.Tab(
                                        ...
                                        children=[
                                            html.Div(
                                                className="tab-content--debug",
                                                children=[
                                                    html.Div(
                                                        className="debug-tables",
                                                        children=[
                                                            html.Div(
                                                                id="debugging-table-div",
                                                                className="result-table-div",
                                                                children=[
                                                                    html.H3(
                                                                        className="table-label",
                                                                        children=[
                                                                            html.Span(id="debugging-table-label"),
                                                                            " Dynex n.quantum Debugging",
                                                                        ],
                                                                    ),
                                                                    html.Div(
                                                                        title="Dynex Output",
                                                                        id="dynex-output-table"
                                                                    ),
                                                                ],
                                                            ),
                                                            html.Div(
