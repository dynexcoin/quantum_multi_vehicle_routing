...
import diskcache
import folium
from dash import MATCH, DiskcacheManager, callback_context, ctx, html
...
def update_debug_log(tab):
    if tab == "debug-tab":
        debug_content = RDL()
        return html.Pre(debug_content)
    return ""
